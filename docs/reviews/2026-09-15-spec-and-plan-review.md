...
| Steering records, proposals and Context PRs | Thin release after core journey | Preserve provenance, author/reviewer roles, merge conflict behavior, rejection and rollback. Publish only to future context assembly; never rewrite a historical run. |
