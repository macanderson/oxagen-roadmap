...
Once unlocked, every page sits in one shell: a sidebar with organization and workspace switchers, the Workspace nav (Fleet, Agent IAM, Tools, Skills, Steering, Spend) and the Organization nav (Organization, Billing, Audit); a top bar with breadcrumbs, ⌘K search-or-run and notifications; and an Account dialog from the user menu. On a phone the sidebar becomes a five-slot thumb bar (Fleet, Agents, Tools, Spend, More) with dialogs as bottom sheets. The in-app agent sits in the shell too, in scope for the first release (maintainer decisions, 2026-09-14 and 2026-09-15); each of its turns is a run of its own, acting through the same governed actions as the screens. It opens as a flyout from the sidebar, and the bottom dock of the `small-approvals-bottom-dock-scenarios` branch is not adopted (maintainer decision, 2026-09-15).
...
Billing is readable by a finance role and shows the plan, this period's lines, the meters and the invoices, with a row opening the Stripe-hosted invoice and Change plan going to Stripe checkout. Billing prices governed action units on one price list ([spec §12.1](mission-control-spec.md#121-what-is-tracked-and-what-is-priced); maintainer decisions of 2026-09-14, reaffirmed 2026-09-15): $5 per 1,000 GAU list, a monthly allowance of 5,000 GAU on Free, 50,000 on Build at $199 and 300,000 on Scale at $999, 5,000-GAU blocks at $25, and Enterprise negotiated per contract, with every feature on every tier. The page prints the customer's contracted rate. `resolve_approval` is the only billable governed action, and proven spend is a report figure. The mockup still prints the proven-run price list, which the spec no longer carries. Tokens are never marked up, and the customer-spend accounting on Spend is unchanged. The billing decisions of 2026-09-15 (credit packs for the in-app agent, negotiated enterprise with every feature on for every tier, invoice billing, the Build and Scale upgrade through Stripe Checkout, suspension) are in [spec §12.10](mission-control-spec.md#1210-billing-decisions-of-2026-09-15).
