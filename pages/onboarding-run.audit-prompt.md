...
2. The design, rendered: `pages/onboarding-run-<state>.html` and `pages/onboarding-run-<state>-mobile.html` for each state (loaded, loading, error, access denied); open them in a browser or with Playwright. `pages/index.html` links all of them.
