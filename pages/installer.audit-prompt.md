...
2. The design, rendered: `pages/installer-<state>.html` and `pages/installer-<state>-mobile.html` for each state (loaded); open them in a browser or with Playwright. `pages/index.html` links all of them.
