...
1. The page spec: `pages/skills-off.md` (read it first, in full), and `pages/skills.md` for the vocabulary it shares.
2. The design, rendered: `pages/skills-off-loaded.html` and `pages/skills-off-loaded-mobile.html`; open them in a browser or with Playwright. `pages/index.html` links all of them.
