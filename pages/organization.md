...
- A workspace owns one main repo, one ontology, one steering set, its agents, tool grants and budgets; a workspace without a main repo cannot exist (it is *provisional*).
