...
| Design | `mc.html` → `pOrganization() with `S.tab.organization="roles"`` (the single source; `consolidated.html` is the product build of it) |
| States | loaded · empty · loading · error · access denied |
| Files | `organization-roles-loaded.html` / `organization-roles-loaded-mobile.html`, `organization-roles-empty.html` / `organization-roles-empty-mobile.html`, `organization-roles-loading.html` / `organization-roles-loading-mobile.html`, `organization-roles-error.html` / `organization-roles-error-mobile.html`, `organization-roles-denied.html` / `organization-roles-denied-mobile.html` |
