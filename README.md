...
| `pages/` | One file per page per state (loaded, empty, loading, error, denied), desktop and mobile — 240 files — plus, beside each page, `<page>.md` (its data sources and functionality) and `<page>.audit-prompt.md` (a prompt that audits a build of that page against the spec). `pages/index.html` is the map; `pages/audit-prompt.md` audits the whole app. See `pages/README.md`. |
