...
- `node tools/check-mockup.mjs`: 4,171 assertions passed, 0 failed. Every page in
...
- `node tools/check-creation.mjs`: 218 passed. `node tools/check-api.mjs`: 60 passed.
  `node tools/check-assistant.mjs`: 49 passed. `node tools/check-record-e2e.mjs`: 121 passed,
