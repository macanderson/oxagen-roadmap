// The catalog of mockups/future_state_mockups/missioncontrol.html, the future-state design (with the
// witness runner, proof, the definition of done and agent scores): every page with the states its renderer implements,
