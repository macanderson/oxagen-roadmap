...
import spec from "../../pages/onboarding-run.md?raw";

export default {
  title: "Future state/Onboarding/Onboarding · First run",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/welcome/run" },
