...
import spec from "../../pages/onboarding-wrap.md?raw";

export default {
  title: "Future state/Onboarding/Onboarding · Wrap an agent",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/welcome/wrap" },
