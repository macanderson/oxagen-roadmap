...
import spec from "../../pages/agent.md?raw";

export default {
  title: "Future state/Workspace/Agent",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/a-intel/core-platform/agents/triage" },
