...
import spec from "../../pages/steering-preview.md?raw";

export default {
  title: "Future state/Workspace/Steering · Preview",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/a-intel/core-platform/steering/preview/release-manager" },
