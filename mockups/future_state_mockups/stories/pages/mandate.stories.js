...
import spec from "../../pages/mandate.md?raw";

export default {
  title: "Future state/Workspace/Mandate",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/a-intel/finops/agents/invoice-bot/mandates/mnd_7K2ETQ4" },
