...
You are auditing the **Skills** page of Oxagen (`#/a-intel/core-platform/steering/skills[/<tab>]`) for conformance to its design. Be exact and adversarial: the design is the spec, and “close enough” is a fail. Do not summarise what you see; compare it.
