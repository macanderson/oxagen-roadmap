...
- **Toolbelt**: **Belt computation** (Searchable belt / Full belt), **Model view**, **Belt search** (queries: pull request · steering record · stripe payment · delete repository · graph; **Run**), **Per-tool decision rules** (By category / Flat; **What the categories mean** opens `toolcats`): Tool · Category · Decision · Hazard · Egress · Financial · Schema digest; **Off the belt** (Tool · Reason).
