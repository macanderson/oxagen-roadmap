...
3. The product spec for context: `docs/mission-control-spec.md` §10 (the repository, steering and Context PRs), §11.2 (GitHub: events in, code graph up to date), §14, Appendix F; `docs/creation-spec.md` (the one shape all five wizards share).
