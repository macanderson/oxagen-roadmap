...
3. The product spec for context: `docs/mission-control-spec.md` §14 (Mission Control), §10.3 (the Steering PR lifecycle), Appendix F (the pages that survive), Appendix A (target tables); the data mapping in `docs/implementation-plan.md` §3.
