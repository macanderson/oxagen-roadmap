// The catalog of mockups/v3/missioncontrol.html (the v3 mockup: v1 without proof, DoD, witness and
// credit scoring, with token accounting and coaching): every page with the states its renderer implements,
