...
import spec from "../../pages/steering-compiler.md?raw";

export default {
  title: "Oxagen/Workspace/Steering · Compiler",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/a-intel/core-platform/steering/compiler/release-manager" },
