...
import spec from "../../pages/organization-api-keys.md?raw";

export default {
  title: "Future state/Organization/Organization · API keys",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/a-intel/api-keys" },
