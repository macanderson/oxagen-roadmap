...
import spec from "../../pages/steering-policy.md?raw";

export default {
  title: "Future state/Workspace/Steering · Policy",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/a-intel/core-platform/steering/policy" },
