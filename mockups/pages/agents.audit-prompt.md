...
2. **Header.** Eyebrow the workspace name, h1 "Agents", subtext "Every actor in this workspace and what it is made of." Actions in this order: Steer agents…, Write a new agent…, Register agent. Register agent is the one gold action on the screen. There is no Wrap Claude Code button and no Fleet page link.
