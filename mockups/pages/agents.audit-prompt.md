...
6. **Operations columns.** Agent · Harness · Operator · Status · Tier · Belt · Runs 30d · Spend 30d · Tokens 30d · Mandates · Incidents · actions, in that order. Status is the recorded lifecycle status and agrees with Health: an agent Health marks `not enrolled` never reads `enrolled`. Tier is one ladder word. Tokens 30d shows the total over "N% cached". No proven column, no score column.
