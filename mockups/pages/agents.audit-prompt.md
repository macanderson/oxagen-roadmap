...
3. **Summary tiles.** 4 tiles: Agents here · Enrolled · Holding a mandate · Tamper incidents. Each shows one number and one basis line; each number is a rollup of the records it names (recompute it and compare). No score tile, no proven tile.
