# Onboarding harness registration

Onboarding completes after the selected harness sends the test prompt and its run is received.

[Open the interactive wireframe](../missioncontrol.html#/welcome/harness).
