...
5. **One host, one tier.** Every agent row's tier agrees with the host's tier and with the note. An agent on a host at a different tier than the host shows is a FAIL, whichever of the two the build got wrong.
