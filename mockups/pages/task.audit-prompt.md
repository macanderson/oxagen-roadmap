...
1. **Header.** The provider logo and number as the eyebrow, the subject as h1, the one-sentence subtext. **Open in <provider>** links to the issue. The primary follows the readiness table in the spec exactly; one gold on the screen.
