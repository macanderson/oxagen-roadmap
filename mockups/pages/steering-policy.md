...
- **empty**: the hub header, the chip, and the seven tabs stay; the header holds no gold. The body is “No gate applies to this workspace yet”: “No decision rule, mandate or kill switch reaches an agent here, so no gate notice enters steering. Gates are written on Tools and on a mandate’s own page.” Action: **Open Tools · Policy** (not gold; nothing here is authored).
