...
14. **Automatic proposals.** The promoter, the reconciler and a person, each with one line, and no note beneath. The reconciler is named as not built until it ships.
