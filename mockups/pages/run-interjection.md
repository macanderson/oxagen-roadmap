...
- **After the answer**. Link: **The skill it loaded** (the skill row; “1,840 tokens · $0.0055 · priced on the Spend page as context, not as output”). Create: **The workspace that was created**: `a-intel/edge-proxy · .oxagen/workspace.toml` with no `[skills]` block, and **See how core-platform did it** (→ Skills · Versions).
