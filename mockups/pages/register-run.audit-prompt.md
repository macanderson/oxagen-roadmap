...
2. **Header.** Eyebrow “Step 3 of 3”, h1 “Wait for the first frame”, lead as quoted in the spec with the agent key. While waiting the footer is Cancel · Back with the caption “There is no Done button. The frame is the completion.” and no gold action. After the frame the footer is Cancel · the countdown caption · Open in Fleet (gold). A Done or Finish button is a FAIL.
