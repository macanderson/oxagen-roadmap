...
**Changed banner** (readiness `changed` only): the `changed` badge, “The description changed after certification”, and “Priya Natarajan edited it in GitHub on 2026-09-10 17:44. The certification from 2026-09-03 09:15 no longer matches the work item, so it left ready.” Under it, two panels side by side: **Certified against** (the text the certification read) and **Now** (the text today).
