...
You are auditing the **Context record** page of Oxagen Mission Control (`#/a-intel/core-platform/steering/records/<lineage>`) for conformance to its design. Be exact and adversarial: the design is the spec, and “close enough” is a fail. Do not summarise what you see; compare it.
