...
- `policyactivate`, "Activate pol_v42?". Note: "pol_v41 is superseded and kept, because every decision it made cites it. From the next tool call, every policy decision names pol_v42." Rules, Tests, What changes. Warning: "This is a governed action. It records your name, and in regulated mode it is a pull request instead of a button." Footer: Cancel, **Activate it** (gold). Activating supersedes the active version, bumps the deny generation, and reads "pol_v42 is active. Kill-switch generation is now 119."
