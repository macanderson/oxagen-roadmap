...
Step 1 of 3 of Register agent: reserve the agent key. The key is held during setup and can't be changed later. The agent exists only after its first frame reaches Oxagen.
