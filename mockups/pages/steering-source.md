...
**`ontedit`**, "Edit release train": Term, Kind (term, entity, alias or boundary, with the hint on each), Definition (with the wand, "Press the wand. oxagen.assistant rewrites what you wrote into the prose the file carries. Read it before anybody reviews it.") and About. A note: "Saving opens a pull request against .oxagen/ontology/release-train.toml." Footer: Cancel, **Retire** (red; opens `ontretire`) and **Open the pull request** (gold). Opening reports "Opened <pull request> for release train."
