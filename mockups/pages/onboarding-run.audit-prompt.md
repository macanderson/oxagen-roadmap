...
3. The product spec for context: `docs/mission-control-spec.md` §14 (Mission Control), §10.1 (Repositories), Appendix F (the pages that survive), Appendix A (target tables); the data mapping in `docs/implementation-plan.md` §3.
