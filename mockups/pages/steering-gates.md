...
- **Edited on** links out. A decision rule opens **Open Tools · Policy**. A kill switch opens **Open Tools · Kill switches**. A mandate gate opens **Open Tools · Mandates**; a named mandate opens its own Mandate page. A gate compiled from a record's grant opens **Open the record**. No editor is duplicated here.
...
- **empty**: the hub header, the chip, and the five tabs stay; the header holds no gold. The body is “No gate applies to this workspace yet”: “No decision rule, mandate or kill switch reaches an agent here, so no gate notice enters steering. Gates are written on Tools and on a mandate’s own page.” Action: **Open Tools · Policy** (not gold; nothing here is authored).
