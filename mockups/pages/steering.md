...
- **Published records** panel, badge “newest first · git decides what is in force, and the Postgres registry indexes it”. Kind chips with counts: All 59 · rule 25 · constraint 12 · procedure 5 · fact 10 · memory 3 · preference 4 (`aria-pressed`, icon and hue per kind). List controls: Sort (Shown order, Statement A–Z, Statement Z–A), Rows (5, 10, 25, 50, All), and a pager (“1–10 of 59”, ‹ 1 2 3 4 5 6 ›). Cards are newest first, and the statement is always the headline.
