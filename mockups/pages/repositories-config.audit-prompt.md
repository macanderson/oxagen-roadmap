...
9. **Tree.** The paths under `.oxagen/` at the head, with no note beneath. The comments beside paths are copy and claim nothing the record does not hold (the promotions ledger is hash-chained in every mode).
