...
- Table: Tool version · Provider · Category · Hazard · Gate today · Egress · Financial · Schema origin · Digest · On belts · Calls 30d. A row opens `tool`; the Provider cell is a button that opens that provider's drill-down.
