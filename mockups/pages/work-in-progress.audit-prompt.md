...
9. **Rules.** No heading, table header or caption carries a comma, a mid-dot, or a not/never contrast. No person is scored or ranked. The provider’s status and the work order’s state are never one column.
