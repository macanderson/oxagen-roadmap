...
export default {
  ...
  helpers: [
    ...
    ["dispatchMenu(ids)", "engine.js:15380", "The send-to menu shell: header, search field, and `dspList()`."],
    ["dspList()", "engine.js:15371", "Filters agents you operate and published workflows by the search text and renders both groups."],
