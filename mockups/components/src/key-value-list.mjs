...
export default {
  ...
  helpers: [
    ["frKv(rows)", "engine.js:3426", "Writes a `dl.kv` from an array of `[label, value]` pairs, dropping any falsy row. About 15 calls, mostly frame detail."],
    ["kvl(pairs, cls)", "engine.js:10022", "The same shape again: a `dl.kv` from pairs, with an optional extra class. 7 calls, all in the account dialog."],
  ],
  sourceNotes: [
