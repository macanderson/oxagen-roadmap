...
<span class="tk-k">retries</span> <span class="tk-p">=</span> <span class="tk-e">three</span>  <span class="tk-c"># tk-e error</span></pre>`,
  ...
  helpers: [
    ["pAgentSource(r)", "engine.js:1192", "The agent Source page: the header, tabs, and the TOML editor."],
    ...
    ["cedHtml(key, path, lang, opts)", "engine.js:11524", "The same editor for other languages, sized for a dialog with `small` or wrapped for prose."],
  ],
  sourceNotes: [
