...
<span class="tk-k">retries</span> <span class="tk-p">=</span> <span class="tk-e">three</span>  <span class="tk-c"># tk-e error</span></pre>`,
  ...
  helpers: [
    ["pAgentSource(r)", "engine.js:1253", "The agent Source page: the header, tabs, and the TOML editor."],
    ...
    ["hlToml(src)", "engine.js:1223", "The TOML highlighter: one regex pass that writes token classes."],
    ["cedHtml(key, path, lang, opts)", "engine.js:11363", "The same editor for other languages, sized for a dialog with `small` or wrapped for prose."],
  ],
  sourceNotes: [
