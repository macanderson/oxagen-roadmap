...
export default {
  ...
  helpers: [
    ["recordCard(r, x)", "engine.js:1568", "The one function that draws a steering record. `x.right` replaces the status badge and `x.meta` prepends a fact to the meta line. 4 calls."],
  ],
  sourceNotes: [
