...
export default {
  ...
  helpers: [
    ["recordCard(r, x)", "engine.js:1561", "The one function that draws a context record. `x.right` replaces the status badge and `x.meta` prepends a fact to the meta line. 4 calls."],
  ],
  sourceNotes: [
