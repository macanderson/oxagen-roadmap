...
export default {
  ...
  helpers: [
    ["toolCell(id, o)", "engine.js:829", "The one component every tool display goes through. `o.sz` picks a size, `o.sub` appends a fact, `S.toolNames===\"api\"` swaps label and API name. 16 calls."],
    ["toolMeta(id)", "engine.js:811", "Resolves a tool id to its label and category, from `TOOLMETA` or a verb-based guess for an id the table does not name."],
    ["catSvg(c)", "engine.js:826", "The category's icon, from the shared `TCAT` map."],
  ],
  sourceNotes: [
