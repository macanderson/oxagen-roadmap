...
export default {
  ...
  root: ".agc",
  css: "lines 1309 to 1334 (agent card, its three layouts, and the rule comment above them), 1338 (a steer-list override), 2166 to 2167 (the harness mark inside the card)",
