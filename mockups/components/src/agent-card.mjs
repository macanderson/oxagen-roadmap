...
export default {
  ...
  helpers: [
    ["hxIcon(harness, size, alone)", "engine.js:14805", "The harness mark, found by key or by label. `alone` adds `role=\"img\"` and an `aria-label` when no text beside the mark names the harness."],
