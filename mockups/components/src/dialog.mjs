...
export default {
  ...
  helpers: [
    ["dialog()", "engine.js:9350", "Builds the scrim, shell, header, tabs, body, and footer from a `{t, s, w, tabs, b, f}` record. The shell markup is at 9662 to 9667."],
    ["openDialog(kind, arg)", "engine.js:8130", "Opens a dialog by kind and remembers the dialog to return to."],
    ["closeDialog()", "engine.js:8303", "Closes it, or returns to the dialog it was opened from."],
