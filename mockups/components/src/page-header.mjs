...
export default {
  ...
  helpers: [
    ["srcHead(o, kindLabel, title, badges, lead, acts)", "wedge.js:1065", "The header of a Steering source: back link, title, badge row, lead, and actions. It drops a title over 90 characters to 20px."],
