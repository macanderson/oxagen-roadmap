...
export default {
  ...
  helpers: [
    ["kindBadge(k)", "engine.js:1499", "Kind badge with icon and word. 4 calls."],
    ["kindGlyph(k)", "engine.js:1500", "Icon-only kind glyph. 2 calls."],
    ...
    ["catBadge(c)", "engine.js:765", "Tool category badge with icon and word. 5 calls."],
    ["hazard(risk, effect)", "engine.js:789", "Risk mark plus an optional side-effect glyph. 15 calls."],
    ["gate(g, note)", "engine.js:804", "Gate badge, with the reasoning in its title."],
    ["toolGate(t)", "engine.js:816", "Decides which gate a tool sits behind today (a kill switch outranks a mandate outranks approval) and renders it with `gate()`. 5 calls."],
  ],
  sourceNotes: [
