...
export default {
  ...
  helpers: [
    ["kindBadge(k)", "engine.js:1557", "Kind badge with icon and word. 4 calls."],
    ["kindGlyph(k)", "engine.js:1558", "Icon-only kind glyph. 2 calls."],
    ...
    ["catBadge(c)", "engine.js:823", "Tool category badge with icon and word. 5 calls."],
    ["hazard(risk, effect)", "engine.js:847", "Risk mark plus an optional side-effect glyph. 15 calls."],
    ["gate(g, note)", "engine.js:862", "Gate badge, with the reasoning in its title."],
    ["toolGate(t)", "engine.js:874", "Decides which gate a tool sits behind today (a kill switch outranks a mandate outranks approval) and renders it with `gate()`. 5 calls."],
  ],
  sourceNotes: [
