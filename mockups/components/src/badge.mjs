...
export default {
  ...
  helpers: [
    ["statusBadge(st)", "engine.js:706", "A run's status. `live` returns the pulsing `.live` instead of a pill."],
    ["tierBadge(t)", "engine.js:724", "A tier with its definition as the title. 25 calls."],
    ["riskBadge(r)", "engine.js:734", "low, medium, high, critical."],
    ["effBadge(e)", "engine.js:738", "A side effect: irreversible or write."],
    ...
    ["stBadge(m)", "engine.js:6993", "A dot badge from a status map. 13 calls."],
    ["tStatusBadge(k)", "engine.js:15045", "A work item's status."],
    ["readyBadge(t)", "engine.js:15059", "A work item's readiness."],
    ["permChips(perms, max)", "engine.js:10139", "Permissions as mono neutral badges with `SEP` between them."],
  ],
  sourceNotes: [
