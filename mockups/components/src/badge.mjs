...
export default {
  ...
  helpers: [
    ...
    ["stBadge(m)", "engine.js:7242", "A dot badge from a status map. 13 calls."],
    ["tStatusBadge(k)", "engine.js:15095", "A work item's status."],
    ["readyBadge(t)", "engine.js:15109", "A work item's readiness."],
    ["permChips(perms, max)", "engine.js:10283", "Permissions as mono neutral badges with `SEP` between them."],
  ],
  sourceNotes: [
