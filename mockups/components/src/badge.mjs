...
export default {
  ...
  helpers: [
    ...
    ["stBadge(m)", "engine.js:7240", "A dot badge from a status map. 13 calls."],
    ["tStatusBadge(k)", "engine.js:15091", "A work item's status."],
    ["readyBadge(t)", "engine.js:15105", "A work item's readiness."],
    ["permChips(perms, max)", "engine.js:10281", "Permissions as mono neutral badges with `SEP` between them."],
  ],
  sourceNotes: [
