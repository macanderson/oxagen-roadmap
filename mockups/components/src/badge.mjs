...
export default {
  ...
  helpers: [
    ...
    ["stBadge(m)", "engine.js:6912", "A dot badge from a status map. 13 calls."],
    ["tStatusBadge(k)", "engine.js:14767", "A work item's status."],
    ["readyBadge(t)", "engine.js:14781", "A work item's readiness."],
    ["permChips(perms, max)", "engine.js:10052", "Permissions as mono neutral badges with `SEP` between them."],
  ],
  sourceNotes: [
