...
export default {
  ...
  helpers: [
    ...
    ["stBadge(m)", "engine.js:6865", "A dot badge from a status map. 13 calls."],
    ["tStatusBadge(k)", "engine.js:14708", "A work item's status."],
    ["readyBadge(t)", "engine.js:14722", "A work item's readiness."],
    ["permChips(perms, max)", "engine.js:9906", "Permissions as mono neutral badges with `SEP` between them."],
  ],
  sourceNotes: [
