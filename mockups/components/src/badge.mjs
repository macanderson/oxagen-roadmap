...
export default {
  ...
  helpers: [
    ...
    ["stBadge(m)", "engine.js:6913", "A dot badge from a status map. 13 calls."],
    ["tStatusBadge(k)", "engine.js:14788", "A work item's status."],
    ["readyBadge(t)", "engine.js:14802", "A work item's readiness."],
    ["permChips(perms, max)", "engine.js:10058", "Permissions as mono neutral badges with `SEP` between them."],
  ],
  sourceNotes: [
