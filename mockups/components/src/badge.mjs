...
export default {
  ...
  helpers: [
    ...
    ["stBadge(m)", "engine.js:7209", "A dot badge from a status map. 13 calls."],
    ["tStatusBadge(k)", "engine.js:15062", "A work item's status."],
    ["readyBadge(t)", "engine.js:15076", "A work item's readiness."],
    ["permChips(perms, max)", "engine.js:10250", "Permissions as mono neutral badges with `SEP` between them."],
  ],
  sourceNotes: [
