...
export default {
  ...
  helpers: [
    ...
    ["stBadge(m)", "engine.js:6970", "A dot badge from a status map. 13 calls."],
    ["tStatusBadge(k)", "engine.js:14826", "A work item's status."],
    ["readyBadge(t)", "engine.js:14840", "A work item's readiness."],
    ["permChips(perms, max)", "engine.js:10111", "Permissions as mono neutral badges with `SEP` between them."],
  ],
  sourceNotes: [
