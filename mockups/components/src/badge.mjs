...
export default {
  ...
  helpers: [
    ...
    ["stBadge(m)", "engine.js:6869", "A dot badge from a status map. 13 calls."],
    ["tStatusBadge(k)", "engine.js:14723", "A work item's status."],
    ["readyBadge(t)", "engine.js:14737", "A work item's readiness."],
    ["permChips(perms, max)", "engine.js:9921", "Permissions as mono neutral badges with `SEP` between them."],
  ],
  sourceNotes: [
