...
export default {
  ...
  helpers: [
    ...
    ["stBadge(m)", "engine.js:6833", "A dot badge from a status map. 13 calls."],
    ["tStatusBadge(k)", "engine.js:14676", "A work item's status."],
    ["readyBadge(t)", "engine.js:14690", "A work item's readiness."],
    ["permChips(perms, max)", "engine.js:9874", "Permissions as mono neutral badges with `SEP` between them."],
  ],
  sourceNotes: [
