...
export default {
  ...
  helpers: [
    ["statusBadge(st)", "engine.js:704", "A run's status. `live` returns the pulsing `.live` instead of a pill."],
    ["tierBadge(t)", "engine.js:722", "A tier with its definition as the title. 25 calls."],
    ["riskBadge(r)", "engine.js:732", "low, medium, high, critical."],
    ["effBadge(e)", "engine.js:736", "A side effect: irreversible or write."],
    ["finBadge(f)", "engine.js:740", "A financial class as a critical label, or a dim none."],
    ["originBadge(o)", "engine.js:743", "Where a tool schema came from: observed, or observed and approved."],
    ["stBadge(m)", "engine.js:6973", "A dot badge from a status map. 13 calls."],
    ["tStatusBadge(k)", "engine.js:14829", "A work item's status."],
    ["readyBadge(t)", "engine.js:14843", "A work item's readiness."],
    ["permChips(perms, max)", "engine.js:10114", "Permissions as mono neutral badges with `SEP` between them."],
  ],
  sourceNotes: [
