...
export default {
  ...
  helpers: [
    ...
    ["stBadge(m)", "engine.js:6855", "A dot badge from a status map. 13 calls."],
    ["tStatusBadge(k)", "engine.js:14634", "A work item's status."],
    ["readyBadge(t)", "engine.js:14648", "A work item's readiness."],
    ["permChips(perms, max)", "engine.js:9907", "Permissions as mono neutral badges with `SEP` between them."],
  ],
  sourceNotes: [
