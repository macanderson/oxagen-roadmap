...
export default {
  ...
  root: ".bar, .meter, .stk",
  css: "lines 318 to 322 (bar and meter), 765 (bar hold), 1395 to 1398 (stacked ratio), 1376 to 1379 (legend), 2057 to 2060 (meter, defined a second time)",
  ...
  anatomy: [
    ...
    ["Meter", "`.meter`", "The label-and-bar unit, a grid with a 5px gap. Defined twice (engine.css 321 and 2057). The later definition wins."],
  ...
  helpers: [
    ["stgMeter(label, used, max, unit, sub)", "engine.js:6393", "Single-value meter with `role=\"img\"` and an aria-label stating the percent. Holds at 90%."],
    ["tokBars(t, opts)", "engine.js:193", "One composition meter per prompt part, plus output and reasoning, each in its own hue."],
    ["stack3(parts, total)", "engine.js:2592", "One `.stk` segment per part, sized by flex, each with a tooltip."],
    ["stackLeg(parts)", "engine.js:2595", "The `.leg` row naming each part `stack3()` drew."],
    ["mandateBar(m, showReserve)", "engine.js:1741", "The `.mbar` budget bar plus its own `.mlegend`, for a mandate card and the mandate page."],
  ],
  sourceNotes: [
    ...
    "`.fb` and `.pr-bar` are declared beside `.mbar` in the CSS (engine.css 1548 to 1559) as page-bound variants. `.fb` is live on Run. `.pr-bar` renders nowhere. See Findings.",
  ],
  findings: [
    ...
    { tag: "note", title: "`.pr-bar` has no emitter", body: "Declared at engine.css 1555 to 1559 with its own label, track, and value columns. Nothing in engine.js or wedge.js renders one." },
