...
export default {
  ...
  helpers: [
    ["stgMeter(label, used, max, unit, sub)", "engine.js:6728", "Single-value meter with `role=\"img\"` and an aria-label stating the percent. Holds at 90%."],
    ["tokBars(t, opts)", "engine.js:196", "One composition meter per prompt part, plus output and reasoning, each in its own hue."],
    ["stack3(parts, total)", "engine.js:2662", "One `.stk` segment per part, sized by flex, each with a tooltip."],
    ["stackLeg(parts)", "engine.js:2665", "The `.leg` row naming each part `stack3()` drew."],
    ["mandateBar(m, showReserve)", "engine.js:1804", "The `.mbar` budget bar plus its own `.mlegend`, for a mandate card and the mandate page."],
  ],
  sourceNotes: [
