...
export default {
  ...
  helpers: [
    ["listify()", "engine.js:13853", "After every render, runs `ltTable()` on each table in the page and the dialog layer, and `ltCards()` on each card list."],
    ["ltTable(table, prefix)", "engine.js:13753", "Reads the table, picks filters, makes headers sortable, and inserts the bar and pager."],
    ["ltBar(st, opts, apply)", "engine.js:13701", "Writes the control bar: search, filters, an optional Sort, and Rows."],
    ["ltPager(st, total, onPage)", "engine.js:13676", "Writes the range and the page buttons, with ellipses past seven pages."],
    ["ltCards(cfg)", "engine.js:13822", "The same bar and pager for card lists, configured in `LT_CARDS`."],
    ["cardTables()", "engine.js:13919", "Turns tables into labelled cards in the phone shell."],
  ],
  sourceNotes: [
