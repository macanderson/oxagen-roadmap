...
export default {
  ...
  helpers: [
    ["tipAttr(s)", "engine.js:2065", "Writes the `data-tip` attribute and the four event handlers. 16 calls, across the run instruments, the calls panel, the token bars, the step stack, and the Spend charts."],
    ["rtTip(node, ev)", "engine.js:2066", "Creates `#rtip` once, sets its text from `data-tip`, and positions it above the target, flipping below when it would clip the top of the viewport."],
    ["rtTipHide()", "engine.js:2076", "Hides `#rtip` on mouseleave or blur."],
  ],
  findings: [
