...
export default {
  ...
  helpers: [
    ["tipAttr(s)", "engine.js:2066", "Writes the `data-tip` attribute and the four event handlers. 16 calls, across the run instruments, the calls panel, the token bars, the step stack, and the Spend charts."],
    ...
    ["rtTipHide()", "engine.js:2077", "Hides `#rtip` on mouseleave or blur."],
  ],
  findings: [
