...
export default {
  ...
  helpers: [
    ["notifsBody()", "engine.js:1749", "Writes the notification list, one `.li` per entry, unread ones as buttons via `notifRead()`."],
    ["notifIcon(tone)", "engine.js:1742", "The tone's icon: a check for allowed, a clock for approval, a confetti mark for gold, a triangle for anything else, including failed and critical."],
    ["accountBody()", "engine.js:10056", "The Security tab's two `.lst` lists, with an inline-styled `.ic` instead of a tone class."],
  ],
  sourceNotes: [
