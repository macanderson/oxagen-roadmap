...
export default {
  ...
  helpers: [
    ["dialog()", "engine.js:9507", "Writes a dialog's footer buttons from `d.f`."],
    ["act(msg, tone)", "engine.js:1975", "What most buttons call when they finish: a toast in the button's tone."],
  ],
  sourceNotes: [
