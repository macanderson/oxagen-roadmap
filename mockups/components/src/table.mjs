...
export default {
  ...
  helpers: [
    ["rowClick(on, label)", "engine.js:7205", "Makes a row a keyboard button. 17 calls."],
    ["cardTables()", "engine.js:14036", "Turns every single-header table into labelled cards on a phone."],
