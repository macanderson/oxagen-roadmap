...
export default {
  ...
  helpers: [
    ["rowClick(on, label)", "engine.js:6889", "Makes a row a keyboard button. 17 calls."],
    ["cardTables()", "engine.js:13812", "Turns every single-header table into labelled cards on a phone."],
    ["keyLabel(k)", "engine.js:629", "Shows a stored key as its label with the key in a tooltip."],
  ],
  sourceNotes: [
