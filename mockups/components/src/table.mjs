...
export default {
  ...
  helpers: [
    ["rowClick(on, label)", "engine.js:6970", "Makes a row a keyboard button. 17 calls."],
    ["cardTables()", "engine.js:13919", "Turns every single-header table into labelled cards on a phone."],
