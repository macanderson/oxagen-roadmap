...
export default {
  ...
  helpers: [
    ["namesToggle()", "engine.js:829", "Labels or API names for tools. The reference `.seg`."],
    ["catChips(counts, sel, pick, total)", "engine.js:834", "The tool category filter row, `.row.tcs`, with `aria-pressed`."],
  ],
  sourceNotes: [
