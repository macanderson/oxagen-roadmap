...
export default {
  ...
  helpers: [
    ["avatarHtml(av, size, shape, extra)", "engine.js:326", "The one avatar renderer: reads `{kind, icon|text|src, font, tone}` off a record and writes the `.avx` span."],
    ["personAv(key, size)", "engine.js:335", "Looks up a person by key and renders them round. 11 calls."],
    ["agentAv(a, size)", "engine.js:336", "Takes an agent object or key and renders it as a squircle. 8 calls."],
  ],
  sourceNotes: [
