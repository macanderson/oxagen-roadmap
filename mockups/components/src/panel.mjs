...
export default {
  ...
  helpers: [
    ["panel(title, sub, btn, head, rows)", "engine.js:3154", "A local helper inside `tkFieldsTab()` for the Work fields tables. It is the only one."],
    ["listify()", "engine.js:13791", "Adds the list controls to every table inside a panel after each render."],
  ],
  sourceNotes: [
