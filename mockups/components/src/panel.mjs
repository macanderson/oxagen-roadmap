...
export default {
  ...
  helpers: [
    ["panel(title, sub, btn, head, rows)", "engine.js:15120", "A local helper inside `tkFieldsTab()` for the Work fields tables. It is the only one."],
    ["listify()", "engine.js:13746", "Adds the list controls to every table inside a panel after each render."],
  ],
  sourceNotes: [
