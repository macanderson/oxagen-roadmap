...
export default {
  ...
  helpers: [
    ["skeleton()", "engine.js:910", "The loading state: four stat blocks and a panel of seven rows."],
    ["emptyState(t, p, acts)", "engine.js:917", "The empty state with a heading, text, and actions."],
    ["errorState(what, code)", "engine.js:922", "The error state with the control plane's code, Try again, and Open an incident."],
    ["deniedState(what, need)", "engine.js:931", "The denied state with the permission, Request access, and the facts."],
  ],
  sourceNotes: [
