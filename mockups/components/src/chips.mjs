...
export default {
  ...
  helpers: [
    ["agentRoleChips(a)", "engine.js:10075", "Every role an agent holds, as removable chips joined by `SEP`, with an Assign role button."],
    ["edgeChip(it)", "engine.js:3181", "One provenance edge, plus a `button.edge` per frame it cites."],
    ["lblChip(k)", "engine.js:14703", "One work-item label, colored from the tracker's own value."],
    ["lblChips(ks)", "engine.js:14703", "A `.lbls` row of `lblChip()`."],
    ["tagChip(t)", "engine.js:14731", "One DoD tag."],
    ["tkPerson(id, opts)", "engine.js:14721", "A provider account as a mapped teammate or a raw handle."],
  ],
  sourceNotes: [
