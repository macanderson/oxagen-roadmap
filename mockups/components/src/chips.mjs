...
export default {
  ...
  helpers: [
    ["agentRoleChips(a)", "engine.js:10043", "Every role an agent holds, as removable chips joined by `SEP`, with an Assign role button."],
    ...
    ["lblChips(ks)", "engine.js:14671", "A `.lbls` row of `lblChip()`."],
    ["tagChip(t)", "engine.js:14699", "One DoD tag."],
    ["tkPerson(id, opts)", "engine.js:14689", "A provider account as a mapped teammate or a raw handle."],
  ],
  sourceNotes: [
