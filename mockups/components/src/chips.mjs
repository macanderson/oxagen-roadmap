...
export default {
  ...
  helpers: [
    ["agentRoleChips(a)", "engine.js:10287", "Every role an agent holds, as removable chips joined by `SEP`, with an Assign role button."],
    ["edgeChip(it)", "engine.js:3186", "One provenance edge, plus a `button.edge` per frame it cites."],
    ["lblChip(k)", "engine.js:14821", "One work-item label, colored from the tracker's own value."],
    ["lblChips(ks)", "engine.js:14825", "A `.lbls` row of `lblChip()`."],
    ["tagChip(t)", "engine.js:14852", "One DoD tag."],
    ["tkPerson(id, opts)", "engine.js:14843", "A provider account as a mapped teammate or a raw handle."],
  ],
  sourceNotes: [
