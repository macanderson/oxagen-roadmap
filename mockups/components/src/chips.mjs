...
export default {
  ...
  helpers: [
    ["agentRoleChips(a)", "engine.js:10295", "Every role an agent holds, as removable chips joined by `SEP`, with an Assign role button."],
    ["edgeChip(it)", "engine.js:3193", "One provenance edge, plus a `button.edge` per frame it cites."],
    ["lblChip(k)", "engine.js:14930", "One work-item label, colored from the tracker's own value."],
    ["lblChips(ks)", "engine.js:14934", "A `.lbls` row of `lblChip()`."],
    ["tagChip(t)", "engine.js:14961", "One DoD tag."],
    ["tkPerson(id, opts)", "engine.js:14952", "A provider account as a mapped teammate or a raw handle."],
  ],
  sourceNotes: [
