...
export default {
  ...
  helpers: [
    ...
    ["lblChip(k)", "engine.js:15026", "One work-item label, colored from the tracker's own value."],
    ["lblChips(ks)", "engine.js:15030", "A `.lbls` row of `lblChip()`."],
    ["tagChip(t)", "engine.js:15058", "One DoD tag."],
    ["tkPerson(id, opts)", "engine.js:15048", "A provider account as a mapped teammate or a raw handle."],
  ],
  sourceNotes: [
