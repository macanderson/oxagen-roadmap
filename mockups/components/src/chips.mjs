...
export default {
  ...
  helpers: [
    ...
    ["lblChip(k)", "engine.js:14965", "One work-item label, colored from the tracker's own value."],
    ["lblChips(ks)", "engine.js:14969", "A `.lbls` row of `lblChip()`."],
    ["tagChip(t)", "engine.js:14996", "One DoD tag."],
    ["tkPerson(id, opts)", "engine.js:14987", "A provider account as a mapped teammate or a raw handle."],
  ],
  sourceNotes: [
