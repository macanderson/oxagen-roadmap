...
export default {
  ...
  helpers: [
    ["tile(k, v, s, col)", "engine.js:2543", "Writes one stat box. `col` sets the value's tone. About 15 calls."],
    ["runStatRow(R)", "engine.js:2540", "The Run page's row of six, with a local tile of its own."],
