...
export default {
  ...
  helpers: [
    ["runTabs(R, t)", "engine.js:2782", "The Run page's five tabs, with the state dot and the Cost figure."],
    ["tabN(n, title, style)", "engine.js:677", "A count with its hidden space and title. Renders nothing for zero."],
    ["dialog()", "engine.js:9565", "Renders `d.tabs` into a strip between a dialog's header and body."],
  ],
  sourceNotes: [
