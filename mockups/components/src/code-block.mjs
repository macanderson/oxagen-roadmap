...
<span class="c"># one page per call</span></pre></div></div>`,
  ...
  helpers: [
    ["frJson(o, ind)", "engine.js:3425", "Writes a JSON value with `.k` keys and `.s` strings."],
    ["frPre(o)", "engine.js:3434", "Wraps `frJson()` in a wrapping `pre` for the frame detail."],
    ["readout(title, right, inner)", "engine.js:3790", "The labelled slab of what the model read. Two calls, both in frame detail."],
