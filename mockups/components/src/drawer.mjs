...
export default {
  ...
  helpers: [
    ["apdButton()", "engine.js:1693", "The topbar trigger, with the live count."],
    ["apdToggle(v)", "engine.js:1699", "Opens or closes the drawer and clears the selection on close."],
    ["apdRow(a)", "engine.js:1702", "One approval row, pending or resolved."],
    ["apdInterjectionRow(x)", "engine.js:1714", "The paused-agent row, with its own Answer button."],
    ["apdBody(a)", "engine.js:1720", "The list, or the selected approval's card when `S.apd.sel` is set."],
    ["apdHtml()", "engine.js:1734", "The scrim and the panel, assembled from `apdBody()`."],
    ["approvalCard(a)", "engine.js:1906", "The full card shown for a selected row, shared with the Run page."],
  ],
  sourceNotes: [
