...
export default {
  ...
  helpers: [
    ["stageChain(wf, opts)", "engine.js:14877", "Writes the `.stages` row from a workflow's stage list, plus a final Accept card. `opts.state(i)` returns each stage's class."],
    ["stState(i)", "engine.js:15496", "A work order's per-stage state function: `done` once sealed and not returned, `on` while live or next up, empty while queued."],
  ],
  sourceNotes: [
