...
import spec from "../../pages/tasks-providers.md?raw";

export default {
  title: "Oxagen/Workspace/Tasks · Providers",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/a-intel/core-platform/tasks/providers" },
