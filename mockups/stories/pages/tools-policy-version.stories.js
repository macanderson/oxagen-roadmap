...
import spec from "../../pages/tools-policy-version.md?raw";

export default {
  title: "Oxagen/Tools/Policy version",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/a-intel/core-platform/tools/policy/pol_v42" },
