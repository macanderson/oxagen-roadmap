...
import spec from "../../pages/agent-identity.md?raw";

export default {
  title: "Oxagen/Agents/Identity",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/a-intel/core-platform/agents/triage/identity" },
