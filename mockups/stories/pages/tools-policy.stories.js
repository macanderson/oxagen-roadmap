...
import spec from "../../pages/tools-policy.md?raw";

export default {
  title: "Oxagen/Tools/Policy",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/a-intel/core-platform/tools/policy" },
