...
import spec from "../../pages/task.md?raw";

export default {
  title: "Oxagen/Workspace/Task",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/a-intel/core-platform/tasks/tsk_01K6S7C5PA" },
