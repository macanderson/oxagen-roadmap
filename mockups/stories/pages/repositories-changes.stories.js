...
import spec from "../../pages/repositories-changes.md?raw";

export default {
  title: "Oxagen/Repositories/Changes",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/a-intel/core-platform/repositories/changes" },
