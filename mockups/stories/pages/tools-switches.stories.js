...
import spec from "../../pages/tools-switches.md?raw";

export default {
  title: "Oxagen/Tools/Kill switches",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/a-intel/core-platform/tools/switches" },
