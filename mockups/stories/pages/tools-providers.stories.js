...
import spec from "../../pages/tools-providers.md?raw";

export default {
  title: "Oxagen/Tools/Providers",
  tags: ["autodocs"],
  argTypes,
  args: { shell: "desktop", theme: "system", product: true, hash: "#/a-intel/core-platform/tools/providers" },
